...
# print(find(cv2.cvtColor(np.array(pyautogui.screenshot()), cv2.COLOR_BGR2RGB), cv2.imread('./pic/aa.png')))
# tem = cv2.cvtColor(np.array(pyautogui.screenshot()), cv2.COLOR_BGR2RGB)
# find_and_click(tem, cv2.imread('./pic/dungeon/store/leave.png'))
